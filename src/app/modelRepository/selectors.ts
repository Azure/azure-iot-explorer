...
export const getPublicRepositoryHostName = (state: StateInterface) => {
    return state && state.modelRepositoryState && state.modelRepositoryState.publicRepositorySettings && state.modelRepositoryState.publicRepositorySettings.publicRepoHostName;
};
