...
export const getDevicePropertyTupleSelector = (state: StateType): TwinWithSchema[] => {
...
const getDevicePropertyProps = (state: StateType, model: ModelDefinition): TwinWithSchema[] => {
