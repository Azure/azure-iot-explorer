...
import { getUserProfileTokenAction, loginAction, logoutAction, getSubscriptionListAction, getIotHubsBySubscriptionAction, getIoTHubKeyAction, getTenantListAction } from './actions';
...
import { getTenantListSaga } from './sagas/getTenantListSaga';
...
export function* azureActiveDirectorySaga() {
    ...
    yield takeLatest(getTenantListAction.started, getTenantListSaga);
