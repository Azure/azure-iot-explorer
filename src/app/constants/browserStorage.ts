...
export const CONFIGURABLE_REPOSITORY_PATH_NAME = 'CONFIGURABLE_REPOSITORY_PATH_NAME';
export const AUTHENTICATION_METHOD_PREFERENCE = 'AUTHENTICATION_METHOD_PREFERENCE';
export const CONNECTION_STRING_THROUGH_AAD = 'CONNECTION_STRING_THROUGH_AAD';
