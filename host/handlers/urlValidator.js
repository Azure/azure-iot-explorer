...
exports.validateAzureIoTHostname = validateAzureIoTHostname;
exports.validateEventHubHostname = validateEventHubHostname;
exports.extractEventHubHostname = extractEventHubHostname;
 ...
 */
function validateAzureIoTHostname(hostname) {
 ...
 * - Each label follows DNS naming rules
 */
function validateEventHubHostname(hostname) {
    if (!hostname || typeof hostname !== 'string') {
        return false;
    }
    const normalizedHost = hostname.toLowerCase().trim();
 ...
 */
function extractEventHubHostname(connectionString) {
